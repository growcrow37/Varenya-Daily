...
/**
 * @fileOverview A tag suggestion AI agent for blog posts.
 *
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a tag suggestion expert for blog posts. Given the content of a blog post, you will suggest relevant tags to improve its discoverability.
